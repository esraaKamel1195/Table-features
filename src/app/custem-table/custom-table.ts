...
export class CustomTable implements OnInit {
  ...
  columnsConfig: WritableSignal<ColumnsConfig[]> = signal([
    { field: 'id', label: 'Id', type: 'number', groupedBy: false, width: 70, visible: true },
    { field: 'name', label: 'Name', type: 'string', groupedBy: false, width: 150, visible: true },
    {
      field: 'country',
      label: 'Country',
      type: 'string',
    ...
    { field: 'company', label: 'Company', type: 'string', groupedBy: false, width: 150 },
    { field: 'date', label: 'Date', type: 'date', groupedBy: false, width: 150 },
    { field: 'activity', label: 'Activity', type: 'number', groupedBy: false, width: 100 },
    {
      field: 'status',
      label: 'Status',
      type: 'string',
    ...
    { field: 'verified', label: 'Verified', type: 'boolean', groupedBy: false, width: 100 },
    { field: 'balance', label: 'Balance', type: 'number', groupedBy: false, width: 100 },
  ]);
  items: ContextMenuItemsMenu[] = [];
